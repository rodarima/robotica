...
\subsubsection{El giro de la bola y los optoreceptores}

A continuación, trataré de averiguar cómo se mueven los rodillos del ratón, 
cuando la bola gira. Para ello moveré el ratón en la dirección de $\vec{m}$ a 
una velocidad uniforme y en línea recta.
